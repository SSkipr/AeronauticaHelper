...
from AeroHelper.utils.halt import interruptible_sleep, is_halted, raise_if_halted
...
class Keyboard:
    ...
    def hold(self, key, duration, stop_check=None):
        ...
        try:
            ...
            while remaining > 0:
                if is_halted() or (stop_check and stop_check()):
                    break
                step = remaining if not stop_check else min(0.25, remaining)
