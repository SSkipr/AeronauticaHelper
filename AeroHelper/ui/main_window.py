...
class MainWindow(QMainWindow):
    ...
    def _checkbox_definitions(self):
        return ((self.mid_mission_checkbox, self.config.get_start_mid_mission()), (self.custom_waypoint_checkbox, self._custom_waypoint_enabled_for_mode()), (self.quit_after_5_errors_checkbox, self.config.get_quit_after_5_errors()), (self.include_screenshots_checkbox, self.config.get_include_screenshots()), (self.share_data_checkbox, self.config.get_share_data_with_developer()))

    def _checkbox_label(self, checkbox):
        for widget, label in ((self.mid_mission_checkbox, 'Start Mid-Mission'), (self.custom_waypoint_checkbox, 'Custom waypoint'), (self.quit_after_5_errors_checkbox, 'Quit after 5 consecutive errors'), (self.include_screenshots_checkbox, 'Include screenshots in Mission Status'), (self.share_data_checkbox, 'Share data with developer')):
            if checkbox == widget:
                return label
        return None
