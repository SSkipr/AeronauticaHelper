...
import html
import webbrowser
from PyQt5.QtWidgets import QMainWindow, QWidget, QVBoxLayout, QHBoxLayout, QPushButton, QComboBox, QLineEdit, QLabel, QFrame, QMessageBox, QCheckBox, QButtonGroup, QTextEdit, QStyleFactory, QApplication, QDialog, QScrollArea, QToolButton, QProgressBar, QGraphicsDropShadowEffect
...
class MainWindow(QMainWindow):
    ...
    def _build_option_checkboxes(self, layout):
        ...
        self.skip_bearing_checkbox.setStyleSheet('QToolTip { color: #000000; background-color: #FFFFDC; border: 1px solid #888888; }')
        ...
        self.skip_bearing_info.setStyleSheet(f'QLabel {{ color: {WARNING_TEXT}; padding: 0 2px; }} QToolTip {{ color: #000000; background-color: #FFFFDC; border: 1px solid #888888; }}')
        ...
        self.quit_after_5_errors_checkbox.setToolTip('When checked: stops automation and sends @everyone to Discord after 5 consecutive errors')
    ...
    def _build_contributors_footer(self, layout):
        self._add_separator(layout)
        self.contributors_btn = QPushButton('View Contributors on Website')
        ...
        layout.addWidget(self.contributors_btn)
    ...
    def _set_initial_window_size(self):
        ...
        if screen:
            ...
            width = min(max(int(available.width() * 0.2), 340), 440)
            height = min(max(int(available.height() * 0.78), 540), 760, available.height() - 80)
