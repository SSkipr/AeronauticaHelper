...
class MonitoringMode:
    ...
    def __init__(self, cycle_interval, webhook_url, logger, human_detector=None, notification_mode='all', custom_waypoint=False, include_screenshots=False, keyboard=None, skip_current_bearing=False):
